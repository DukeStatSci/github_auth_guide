...
```shell
jovyan@fa45fed244b1:~/work$ cat ~/.ssh/id_rsa.pub
...
As described in the preceding section, you can now test that the SSH authentication is working by attempting to clone a private repository (make sure to select the SSH url and *not* HTTPS).
